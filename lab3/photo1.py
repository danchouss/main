...
def dog(t):
    ...
    rect(dog_surface, black_color, (int(t * 22), int(t * 0), int(t * 95), int(t * 95)), r * 1)
    ellipse(dog_surface, sobaken_color, (int(t * 5), int(t * 0), int(t * 30), int(t * 35)))
    ellipse(dog_surface, black_color, (int(t * 5), int(t * 0), int(t * 30), int(t * 35)), r * 1)
    ellipse(dog_surface, sobaken_color, (int(t * 100), int(t * 0), int(t * 30), int(t * 35)))
    ellipse(dog_surface, black_color, (int(t * 100), int(t * 0), int(t * 30), int(t * 35)), r * 1)
